            ...
            <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500 pb-10">
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-100 flex flex-col md:flex-row md:items-center gap-6 shadow-md transition-all duration-300">
                    ...
                    <div className="flex-1">
                        <h4 className="text-[15px] font-bold text-gray-900">Account limits</h4>
                        <p className="text-[14px] text-gray-500 mt-1 max-w-2xl text-justify leading-relaxed">
                            Your current membership plan allows for up to <strong className="text-gray-900">{user?.subMemberLimit || 0} sub-member slots</strong>. 
