                                ...
                                <table className="w-full text-left">
                                    <thead className="bg-gray-50 border-b border-gray-200">
                                        <tr>
                                            ...
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">PAN</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">CIN</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">Aadhar</th>
                                        ...
                                        {defaulters.map((def, i) => {
                                            ...
                                            return (
                                                <tr key={def._id} className={`${isPaid ? 'bg-green-50/50 hover:bg-green-100/50' : 'hover:bg-gray-50/80'} transition-colors`}>
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <p className="text-xs text-gray-500 font-mono tracking-tighter">{def.pan_number || '-'}</p>
                                                    </td>
                                                    <td className="px-6 py-4">
                                                        <p className="text-xs text-gray-500 font-mono tracking-tighter">{def.cin_number || '-'}</p>
                                                    </td>
                                                    <td className="px-6 py-4">
                                                        <p className="text-xs text-gray-500 font-mono tracking-tighter">{def.aadhar_number || '-'}</p>
                                                    </td>
                                                    <td className="px-6 py-4">
                                                    ...
                                                    <td className="px-6 py-4 text-center">
                                                        <span className={`${(Number(def.outstanding_amount ?? def.default_amount) === 0) ? 'bg-green-50 text-green-600 border border-green-100' : 'bg-red-50 text-red-600 border border-red-100'} px-2 py-1 rounded text-[10px] font-bold`}>
                                                            {Number(def.outstanding_amount ?? def.default_amount) === 0 ? 'Not Defaulter' : 'Defaulter'}
                                                        </span>
                                                    </td>
                                                    <td className="px-6 py-4 text-center">
                                                        <button
