...
const InfoItem = ({ icon, label, value }: { icon: any, label: string, value: any }) => (
    <div className="flex items-start gap-4">
        ...
        <div className="min-w-0">
            <p className="text-[11px] font-black text-gray-400  tracking-widest flex items-center gap-1">
                    ...
                    {!hasSearched ? (
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            <div className="bg-green-600 px-6 py-3">
                                <span className="text-white text-xs font-bold  tracking-widest leading-none">Search Results: {defaulters.length} Match(es)</span>
                            </div>
                                ...
                                <table className="w-full text-left">
                                    <thead className="bg-gray-50 border-b border-gray-200">
                                        <tr>
                                            ...
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">Reported By</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">Reporting Company</th>
                                            ...
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">GST No.</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">PAN No.</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">CIN No.</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider">Aadhar No.</th>
                                            <th className="px-6 py-4 text-xs font-semibold text-gray-500  tracking-wider text-center">Location</th>
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        {defaulters.map((def, i) => (
                                            <tr key={def._id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-6 py-4 text-center">
                                                    <span className="bg-red-50 text-red-600 px-2 py-1 rounded text-[10px] font-bold  border border-red-100">
                                                        Defaulter
                                                    </span>
                                                </td>
                                                <td className="px-6 py-4 text-center">
                            ...
                            <div className="p-0 overflow-y-auto no-scrollbar">
                                ...
                                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-[11px] font-black text-gray-400  tracking-widest">Status</p>
